<template>
  <div>
    ...
    <el-table :data="stationpigs" border>
      ...
      <el-table-column label="饲喂站号" prop="stationid"></el-table-column>
      <el-table-column width="80px" label="品种" prop="pigkind"></el-table-column>
      <el-table-column label="身份码" prop="pigid"></el-table-column>
      <el-table-column label="耳标号" prop="earid"></el-table-column>
      <el-table-column label="与配公猪号" prop="malepignum"></el-table-column>
      <el-table-column width="100px" label="配种日期" prop="breedtime"></el-table-column>
      <el-table-column width="60px" label="背膘厚" prop="backfat"></el-table-column>
      <el-table-column width="50px" label="胎龄" prop="gesage"></el-table-column>
      <el-table-column width="50px" label="品种" prop="kind"></el-table-column>
      <el-table-column label="疫苗情况" prop="vaccine"></el-table-column>
